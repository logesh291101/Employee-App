class RaisedRequestModel {
  const RaisedRequestModel({
  ...
  final List<RaisedRequestData> data;

  factory RaisedRequestModel.fromJson(Map<String, dynamic> json) {
    return RaisedRequestModel(
  ...
  static List<RaisedRequestData> _parseDataList(dynamic raw) {
    if (raw == null) return [];
    if (raw is Map) {
      return [
        RaisedRequestData.fromJson(Map<String, dynamic>.from(raw)),
      ];
    }
    if (raw is! List) return [];

    final items = <RaisedRequestData>[];
    for (final item in raw) {
      if (item is Map) {
        items.add(
          RaisedRequestData.fromJson(Map<String, dynamic>.from(item)),
        );
      }
    }
    return items;
...
class RaisedRequestData {
  const RaisedRequestData({
  ...
  factory RaisedRequestData.fromJson(Map<String, dynamic> json) {
